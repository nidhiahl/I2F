...
avg_Di_score[0]= avg_Di_score[0]/num_iteration
avg_deltaD_score[0]= avg_deltaD_score[0]/num_iteration
      
avg_Di_score.to_csv('../results/'+dataset_name+'/'+update_type+'/PCBIF_avg_ascore_Di.csv',sep=' ',header=None)      
        
avg_deltaD_score.to_csv('../results/'+dataset_name+'/'+update_type+'/PCBIF_avg_ascore_deltaD.csv',sep=' ',header=None)      
