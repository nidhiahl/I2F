...
int main(int argc, char* argv[]){
	...
	for(int pointi =0; pointi < D0_numInstances;pointi++){
   	...
   	//write lazy_AS_D0();
	ofstream outAnomalyScore_lazyD0("../io_directory/lazy_AS_D0.csv", ios::out|ios::binary);
	...
	for(int pointi =0; pointi < deltaD_numInstances;pointi++){
		...
		//write inc_AS_deltaD();
		ofstream outAnomalyScore_incdeltaD("../io_directory/inc_AS_deltaD.csv", ios::out|ios::binary);
		...
		//write inc_AS_D0();
		ofstream outAnomalyScore_incD0("../io_directory/inc_AS_D0.csv", ios::out|ios::binary);
		//ofstream outAnomalyScore("io_directory/inc_AS_deltaD"+to_string(update)+".csv", ios::app|ios::binary);
    	//outAnomalyScore<<"pointId "<<"anomalyscore "<<"actuallabel"<<endl;
    	for(int pointi = 0; pointi < D0_numInstances; pointi++){
