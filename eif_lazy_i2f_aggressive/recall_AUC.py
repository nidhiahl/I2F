...
pred_scores = pd.read_csv('../io_directory/eif_'+method+'_AS_Di.csv',sep=' ',header=None)
Di_size = len(pred_scores)
pred_scores = pd.concat([pred_scores,pd.read_csv('../io_directory/eif_'+method+'_AS_deltaD.csv',sep=' ',header=None)],ignore_index=True)
