...
echo '-----recent-run------'$(date) >> ../results/"$datasetName"/"$updateName"/pcbif_TIME_AAR.csv
echo '**parameters**:itrees='"$numTrees"  >> ../results/"$datasetName"/"$updateName"/pcbif_TIME_AAR.csv
echo 'Running_Time AAR_deltaD AAR_D0' >> ../results/"$datasetName"/"$updateName"/pcbif_TIME_AAR.csv

python3 pcb_for_batch.py "$datasetName" "$updateName" "$numTrees" "$numRuns" >> ../results/"$datasetName"/"$updateName"/pcbif_TIME_AAR.csv

echo -e '\n\n' >> ../results/"$datasetName"/"$updateName"/pcbif_TIME_AAR.csv
